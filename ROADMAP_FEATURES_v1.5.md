...
| **AIDEN_IWO** | Full-stack runtime platform (this repo) — the broader, more versatile project | v0.3.8 (alpha) |
...
- **Post-Processing:** python-pptx, pandoc, LibreOffice (→ OnlyOffice migration planned, timeline TBD)
...
| Skill auto-discovery and recommendation | `[ROADMAP]` |
