...
OUTPUT_KIND: Final[tuple[str, ...]] = ('pptx', 'pdf', 'other', 'html', 'docx', 'md',)
OUTPUT_PACKAGE_KIND: Final[tuple[str, ...]] = ('gamma_pptx', 'gamma_pdf', 'sandbox_pptx', 'sandbox_pdf', 'email_campaign', 'drive_upload', 'crm_mutation', 'figma_handoff', 'stitch_handoff', 'designlab_handoff', 'generic', 'sandbox_html', 'sandbox_docx', 'sandbox_md', 'stitch_html_render', 'figma_html_render', 'twentyfirst_html_render',)
...
OutputKind = Literal['pptx', 'pdf', 'other', 'html', 'docx', 'md']
OutputPackageKind = Literal['gamma_pptx', 'gamma_pdf', 'sandbox_pptx', 'sandbox_pdf', 'email_campaign', 'drive_upload', 'crm_mutation', 'figma_handoff', 'stitch_handoff', 'designlab_handoff', 'generic', 'sandbox_html', 'sandbox_docx', 'sandbox_md', 'stitch_html_render', 'figma_html_render', 'twentyfirst_html_render']
